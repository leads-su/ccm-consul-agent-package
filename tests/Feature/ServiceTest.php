...
namespace ConsulConfigManager\Consul\Agent\Test\Feature;
...
class ServiceTest extends TestCase
{
    ...
    {
        $response = $this->get('/consul/agent/services');
    ...
    {
        $this->createAndGetService();
        $response = $this->get('/consul/agent/services/ccm-example-127.0.0.1');
        $response->assertStatus(200);
     ...
     */
    private function createAndGetService(): ServiceInterface
    {
