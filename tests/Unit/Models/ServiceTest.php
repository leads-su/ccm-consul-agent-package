...
namespace ConsulConfigManager\Consul\Agent\Test\Unit\Models;
...
/**
 * Class ServiceTest
 * @package ConsulConfigManager\Consul\Agent\Test\Unit\Models
 */
class ServiceTest extends TestCase
{
    ...
    {
        ServiceAggregateRoot::retrieve(Arr::get($data, 'uuid'))
            ->createEntity($data)
            ->persist();
        $modelNoTrashed = Service::uuid(Arr::get($data, 'uuid'));
        $modelTrashed = Service::uuid(Arr::get($data, 'uuid'), true);
     ...
     * @return void
     */
    public function testShouldPassIfValidDataReturnedFromGetEnvironmentMethod(array $attributes): void
    {
        $response = $this->model($attributes)->getEnvironment();
        $this->assertEquals(Arr::get($attributes, 'environment'), $response);
    }
     ...
     * @return void
     */
    public function testShouldPassIfValidDataReturnedFromSetEnvironmentMethod(array $attributes): void
    {
        $model = $this->model($attributes);
        $model->setEnvironment('production');
        $this->assertEquals('production', $model->getEnvironment());
    }
     ...
     */
    private function model(array $attributes): ServiceInterface
    {
